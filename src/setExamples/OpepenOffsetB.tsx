...
export default function OpepenOffsetB({ address }: Props) {
  const svg = (address: string) => {
    const minOpacity = 22;
    const maxOpacity = 70;
    // const colors = walletColors(address, 3, 85, 98);
    const colors = walletColors(address, 3, 49, 90, 3, 40, 60);
    const ogColors = gradientForAddress(address, 20, 60, 5, 50, 90);
