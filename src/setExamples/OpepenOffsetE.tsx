...
export default function OpepenOffsetE({ address }: Props) {
  const svg = (address: string) => {
    const minOpacity = 45;
    const maxOpacity = 88;
    const colors = walletColors(address, 5, 5, 25);
    ...
    <path fill="${ogColors[3]}" d="M2000 0H0v2000h2000V0Z" opacity="0.${bgOpacity}" />
